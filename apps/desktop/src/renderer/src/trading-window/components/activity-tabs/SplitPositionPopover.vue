  ...
  >
    ...
    <div class="space-y-3">
      <div>
        ...
        <div
          class="border-border bg-surface flex h-8 w-full items-center justify-between gap-2 rounded-md border px-2 text-xs"
        >
      ...
      <div>
        <label class="text-muted mb-1 block text-xs" for="position-split-amount">
          {{ t('common.amount') }}
        </label>
        <input
          id="position-split-amount"
          :value="props.amount"
          type="number"
          min="0"
          :max="props.maxAmount"
