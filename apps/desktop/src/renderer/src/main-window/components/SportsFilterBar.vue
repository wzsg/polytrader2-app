...
import type { SportsEventScope, SportsMetadataItem } from '@polytrader/shared';
import LoadingSpinner from '@/shared/components/LoadingSpinner.vue';
import { sportCodeLabel } from '../../shared/composables/useSportsEvents';
...
const allLabel = computed(() =>
  props.scope === 'esports' ? t('sports.allEsports') : t('sports.allSports'),
);
